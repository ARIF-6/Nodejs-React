      ...
      >
        ...
        >
          ...
          <div className="relative z-10 text-center">
            ...
            >
              Somali International Scholarship
            </motion.p>
          </div>
        ...
        <div className="w-full md:w-[45%] md:ml-auto h-full p-12 flex flex-col justify-center relative bg-[#1e293b]">
          ...
          >
            <div className="mb-12">
              <motion.h2 variants={itemVariants} className="text-4xl font-bold text-white mb-3">Login</motion.h2>
              <motion.p variants={itemVariants} className="text-gray-400 font-medium">Please enter your credentials</motion.p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-8">
              <motion.div variants={itemVariants} className="group">
                <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] mb-3 px-1">Email Address</label>
                <input
                  type="email"
                  name="email"
                  ...
                  className="w-full bg-[#0f172a] border border-gray-800 text-white placeholder-gray-600 text-sm rounded-2xl py-5 px-6 focus:outline-none focus:border-blue-500 transition-all font-medium"
                  required
                />
              </motion.div>

              <motion.div variants={itemVariants} className="group">
                <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] mb-3 px-1">Password</label>
                <input
                  type="password"
                  name="password"
                  placeholder="••••••••"
              ...
              <motion.div variants={itemVariants} className="flex justify-between items-center px-1">
                <label className="flex items-center space-x-3 cursor-pointer group">
                  <div className="relative">
                    ...
                    <div className="w-5 h-5 border-2 border-gray-800 rounded-md peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-all"></div>
                  </div>
                  <span className="text-xs text-gray-500 group-hover:text-gray-400 transition-colors">Remember me</span>
                </label>
                <a href="/forgot-password" size="xs" className="text-xs text-blue-500 hover:text-blue-400 transition-colors font-bold">
                  Forgot Password?
                </a>
              </motion.div>
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-5 rounded-2xl shadow-xl shadow-blue-600/20 transition-all mt-4"
              >
                {loading ? "Verifying..." : "Sign In"}
              </motion.button>
            </form>

            <motion.div variants={itemVariants} className="mt-12 text-center border-t border-gray-800/50 pt-8">
              <p className="text-sm text-gray-400">
                New User? <a href="/register" className="text-blue-500 font-bold hover:text-blue-400">Create Account</a>
              </p>
            </motion.div>
          </motion.div>
        </div>
